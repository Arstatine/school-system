...
<div class="flex justify-center items-center">
    <div class="container flex justify-center items-center py-[10%] px-4">
        <form action="{{ route('admin.login') }}" class="mt-12 w-full lg:w-1/2 flex flex-col border border-slate-600 py-12 px-12 rounded" method="post">
            @csrf
            <h1 class="text-center mb-4 font-bold text-xl">Admin Login</h1>
